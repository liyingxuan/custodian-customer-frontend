...
<template>
  <div class="reset-pwd-container">
    <div class="Grid">
      <div class="Grid Grid-cell Grid--justifyEnd login-rectangle">
        <img
          style="width: 474px; height: 383px; margin: 53px 81px;"
          src="../../assets/png/Group@2x.png"
          alt
        >
      </div>
      <div class="Grid-cell">
        <div class="new-pwd-form">
          ...
          >
            ...
            <div class="input-tit confirm-password">Confirm New Password</div>
